...
class StringUpdateFunction:
    ...
    """
    З часу запровадження григоріанського календаря (у 1582 році) для визначення виду року використовується наступне правило:

    якщо номер року не ділиться на чотири, то це звичайний рік;
    в іншому випадку, якщо номер року не ділиться на 100, то це високосний рік;
    в іншому випадку, якщо номер року не ділиться на 400, то це звичайний рік;
    в іншому випадку це високосний рік.
    """
